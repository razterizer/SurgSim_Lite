                     ...
                     int anim_ctr)
{
  ...
  int anim = anim_ctr % 6;
  auto bg_color = Color16::White;
  switch (anim)
  {
    case 4:
    case 2:
    case 0: bg_color = Color16::White; break;
    case 1: bg_color = Color16::Yellow; break;
    case 3: bg_color = Color16::Magenta; break;
    case 5: bg_color = Color16::DarkYellow; break;
  }
  if (trig_left)
    sh.write_buffer(" ", tcp_rc_left.r, tcp_rc_left.c, Color16::Default, bg_color);
  if (trig_right)
    sh.write_buffer(" ", tcp_rc_right.r, tcp_rc_right.c, Color16::Default, bg_color);
}
                    ...
                    float dt, float time)
{
  ...
  smoke::smoke_left.draw(sh, "&", Color16::LightGray, Color16::DarkGray, time);
  smoke::smoke_right.draw(sh, "&", Color16::LightGray, Color16::DarkGray, time);
}
